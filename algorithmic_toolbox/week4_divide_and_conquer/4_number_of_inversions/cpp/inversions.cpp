...
long long merge(std::vector<int>& a, std::vector<int>& b, size_t left, size_t ave, size_t right) {
  size_t i = left;
  size_t j = ave + 1;
  size_t k = left;
...
long long getNumberOfInversions(std::vector<int>& a, std::vector<int>& b, size_t left, size_t right) {
